...
* `MSL_PATTERN`: The filename pattern passed to `asli calc` matching the file(s) containing pressure data, e.g. "era5_mean_sea_level_pressure_monthly_${START_YEAR}-${END_YEAR}.nc"
