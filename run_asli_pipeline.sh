...
python src/02_quality_checks.py --stdevs $SD_FROM_MEAN --min $ACTCENPRES_BOUNDS_MIN --max $ACTCENPRES_BOUNDS_MAX "$OUTPUT_DIR/asli_calculation_$FILE_IDENTIFIER.csv"
